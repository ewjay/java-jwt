...
public class EncryptionException extends JWTCreationException {
    public EncryptionException(Algorithm algorithm, String description) {
        super("The cipher text couldn't be generated when encrypting using the Algorithm: " + algorithm + " - " + description, null);
    }
